...
router.post("/register/google", sanitizeBody, requireBody("credential"), registerWithGoogle);
router.post("/google", sanitizeBody, requireBody("credential"), registerWithGoogle);
