...
| Path | Ranges | Reason |
| --- | --- | --- |
| `docs/archive/2026-08/prompts/MASTER_TASK_COACH3_PROJECT_TEXT_ENCODING_RECOVERY.txt` | 17–28, 69–76, 82–84, 90–92, 200–219, 465, 483–485, 1117, 1257–1267 | User-owned master task deliberately includes mojibake examples and detector signatures. It is not application source or runtime data. |
