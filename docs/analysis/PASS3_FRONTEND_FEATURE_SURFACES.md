...
| Loyalty and rewards | `/loyalty` | `/api/loyalty` | `ACTIVE_UI` | Points, PointTransactions, RewardsCatalog and RewardRedemptions are live dependencies; redemption is transaction-owned TypeScript |
